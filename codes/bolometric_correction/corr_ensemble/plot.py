...
ax.plot( x_fit, sigma_H07(x_fit, 0.06, 0.10, 0.08), '--', dashes=(25,15), c='royalblue'  )

pbest,_=curve_fit(new_fit_func, bincenter, sigmas, p0=(0.06, 0.10, 0.08), maxfev=10000)
print pbest
ax.plot(x_fit, new_fit_func(x_fit,*pbest),'-',c='royalblue' )
...
ax.plot( x_fit, sigma_H07(x_fit, 0.046, 0.10, 0.08), '--',dashes=(25,15),  c='crimson'  )

pbest,_=curve_fit(new_fit_func, bincenter, sigmas, p0=(0.046, 0.10, 0.08), maxfev=10000)
print pbest
ax.plot(x_fit, new_fit_func(x_fit,*pbest),'-',c='crimson' )
...
ax.plot( x_fit, sigma_H07(x_fit, 0.08, -0.25, 0.06), '--', dashes=(25,15), c='seagreen'  )

pbest,_=curve_fit(sigma_H07, bincenter, sigmas, p0=(0.08, -0.25, 0.06), maxfev=10000)
print pbest
ax.plot(x_fit, sigma_H07(x_fit,*pbest),'-',c='seagreen' )
...
pbest,_=curve_fit(sigma_H07, bincenter, sigmas, p0=(0.07, -0.17, 0.086), maxfev=10000)
print pbest
ax.plot(x_fit, sigma_H07(x_fit,*pbest),'-',c='chocolate' )

ax.plot([],[],'.', c='k', mec='k', marker='o', markersize=15, label=r'$\rm Binned$ $\rm estimation$')
ax.plot([],[], '--', dashes=(25,15), c='k', label=r'$\rm Hopkins+$ $\rm 2017$')
