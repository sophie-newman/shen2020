...
pro load_Silverman_SX_LF_data, L_HX, PHI_HX, DPHI_HX, z
	...
	if ((z GE 2.0) AND (z LT 3.0)) then WHICH_BLOCK = 5
	if ((z GE 4.0) AND (z LT 5.5)) then WHICH_BLOCK = 7
	...
	L_HX = (L_HX - L_solar) + alog10(1.19) - 0.217 
