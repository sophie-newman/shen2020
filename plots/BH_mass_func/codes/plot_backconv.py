...
i=0
colors=['crimson','royalblue','seagreen','chocolate','darkorchid']
for redshift in [2,3,4,5,6]:
#for redshift in [0.2,0.5,0.8,1.1,1.4,1.7]:
	...
	L_bol_grid_extend = np.linspace(0,15,301)
	catalog["mass"], catalog["weight"] = generate_ensemble(L_bol_grid_extend+L_solar, LF(L_bol_grid_extend,parameters_global_2) )
...
ax.minorticks_on()
plt.savefig("../figs/BHMF.pdf",fmt='pdf')
#plt.show()
