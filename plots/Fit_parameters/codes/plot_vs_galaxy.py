...
ax.errorbar(data["z"]+1,-data["alpha"]-1,yerr=(data['alphalowerr'],data['alphauperr']),capsize=10,linestyle='',c='crimson',mec='crimson',marker='o', ms=15,capthick=4,alpha=0.6)
data=np.genfromtxt("../galaxyLFdata/bouwens2015.dat",names=True)
ax.errorbar(data["z"]+1,-data["alpha"]-1,yerr=data['alphaerr'],linestyle='',c='crimson',mec='crimson',marker='o', ms=15,lw=4,capsize=10,capthick=4,alpha=0.6)
data=np.genfromtxt("../galaxyLFdata/atek2015.dat",names=True)
ax.errorbar(data["z"]+1,-data["alpha"]-1,yerr=([data['alphalowerr']],[data['alphauperr']]),linestyle='',c='crimson',mec='crimson',marker='o', ms=15,lw=4,capsize=10,capthick=4,alpha=0.6)
...
ax.errorbar(data["z"]+1,-data["alpha"]-1,linestyle='',c='royalblue',mec='royalblue',marker='s', ms=15,lw=4,capsize=10,alpha=0.6)
data=np.genfromtxt("../galaxyLFdata/mason2015.dat",names=True)
ax.errorbar(data["z"]+1,-data["alpha"]-1,yerr=data['alphaerr'],linestyle='',c='royalblue',mec='royalblue',marker='s', ms=15,lw=4,capsize=10,capthick=4,alpha=0.6)
data=np.genfromtxt("../galaxyLFdata/tachella2013.dat",names=True)
ax.errorbar(data["z"]+1,-data["alpha"]-1,yerr=(data['alphalowerr'],data['alphauperr']),linestyle='',c='royalblue',mec='royalblue',marker='s', ms=15,lw=4,capsize=10,capthick=4,alpha=0.6)
data=np.genfromtxt("../galaxyLFdata/tachella2018.dat",names=True)
ax.errorbar(data["z"]+1,-data["alpha"]-1,yerr=(data['alphalowerr'],data['alphauperr']),linestyle='',c='royalblue',mec='royalblue',marker='s', ms=15,lw=4,capsize=10,capthick=4,alpha=0.6)
data=np.genfromtxt("../galaxyLFdata/wilkins2017.dat",names=True)
ax.errorbar(data["z"]+1,-data["alpha"]-1,linestyle='',c='royalblue',mec='royalblue',marker='s', ms=15,lw=4,capsize=10,capthick=4,alpha=0.6)
