...
ax.plot(x,y,':',c='crimson',label=r'$\rm old$')
...
x = L_bol_grid + L_solar
y = LF(L_bol_grid,parameters_global_2)
ax.plot(x,y,':',c='royalblue',label=r'$\rm new$')

x,y,dy=get_data(parameters_fix_local,dataid=-1)
ax.errorbar(x,y,yerr=dy,linestyle='none',c='royalblue',mec='royalblue',marker='o',ms=10,capsize=6,capthick=2,lw=2)
